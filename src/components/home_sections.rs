    ...
    <div class="mb-5">
        <div class="grid grid-cols-1 grid-rows-1 place-items-center">
            <video
                ...
                loop
                muted
                class="h-full row-start-1 row-end-1 col-start-1 col-end-1 opacity-30 object-cover"
            >
...
view! {
    <div class="grid grid-cols-1 grid-rows-1 place-items-center">
        <img
            src="/assets/images/taniec_kobieta.webp"
            alt="Happy womans"
            loading="lazy"
            ...
            <AnimateIn>
                <div class="grid grid-cols-2 content-center mx-2">
                    <div class="place-self-center">
                        ...
                        <img
                            class="h-32 md:h-[20vw] max-h-72"
                            src="/assets/images/monitorek.webp"
                            loading="lazy"
                            alt=""
                        />
                    </div>
                    <div class="place-self-center">
                        <div class="h-full flex items-center">
                            <img
                                class="max-w-8 mr-0.5"
                                src="/assets/images/button_deco.webp"
                                loading="lazy"
                                alt=""
                            />
                            <a href="/product">
                            ...
                            <img
                                class="scale-x-[-1] max-w-8 ml-0.5"
                                src="/assets/images/button_deco.webp"
                                loading="lazy"
                                alt=""
                            />
...
view! {
    <AnimateIn>
        <div>
            <p class="py-8 text-center font-gistesy md:text-5xl text-[8vw] text-nowrap">
                "You’re freaking magnetic and you
                know it."
            </p>
        </div>
    </AnimateIn>
    ...
    is_pending: Signal<bool>,
        ...
        view! {
            ...
            <AnimateIn>
                <p class="text-[1rem] text-center">
                    "A soulful guide to finding the message that your dream clients can
                    feel."
                </p>
            </AnimateIn>
            ...
            <form on:submit=on_submit class="mx-auto space-y-3 pt-3">
                ...
                <AnimateIn>
                    <button
                        type="submit"
                        disabled=is_pending
                        class="w-full text-center text-black p-2 bg-(--bg-rose)"
                    >
                        {move || {
                            if is_pending.get() { "SENDING..." } else { "DIVE INTO FREE GUIDE" }
                        }}
                    </button>
                </AnimateIn>
            </form>
        ...
        view! {
            <div class="space-y-10 bg-[url(/assets/images/liscie_o2.webp)] bg-center py-10">
                <AnimateIn>
                    <h3 class="text-[5vw] md:text-3xl text-center">
                        "Meet Luiza - the soul behind the" <br />
                        <span class="font-gistesy text-[7vw] md:text-4xl text-nowrap">
                            "Wildly Magnetic"
                        </span>
                    </h3>
                </AnimateIn>
                <img
                    class="w-[65%] mx-auto"
                    src="/assets/images/luiza_w_marynarce3.webp"
                    loading="lazy"
                    alt=""
                />
                <AnimateIn>
                ...
                <div class="mx-[10%] bg-(--bg-sec) text-[4vw]/[6vw] md:text-2xl text-center space-y-6 py-6">
                    <AnimateIn>
                        <p>
                            "You weren’t born to follow rules." <br />
                ...
                <AnimateIn>
                    <div class="flex justify-center">
                        <button class="text-nowrap text-black text-xl bg-(--bg-rose) h-auto rounded-full p-4 shadow-2xl ">
                            "Activate
                            My Wild Potential!"
                        </button>
                    </div>
        ...
        view! {
            <div class="relative bg-(--bg-darker) px-[10%] pb-10">
                <div class="relative text-sm text-(--bg-lighter) pt-10 space-y-6 z-50">
                    ...
                    <AnimateIn>
                        <p class="text-justify z-50">
                            " You were never meant to live half-alive. You were never meant to
                            silence your magic to fit into a box the world handed you. "
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="text-justify">
                            " Your soul has been calling for more — more freedom, more expression, more
                            truth, more fire, more you. "
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="text-justify">
                            "You were born to create from your core. To move with intention. To lead
                            with energy. To be so wildly magnetic that your presence alone shifts the room."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="text-justify">
                            "And here…we don’t tame that. We amplify it. We build businesses that feel
                            like breath, like warmth in your chest, like coming home after years of being away."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="text-justify">
                    ...
                    <AnimateIn>
                        <p class="text-justify">
                            " If you’re ready to stop performing and start expressing… If you’re ready
                            to trade force for flow, doubt for devotion, pressure for power… If you’re ready to build a
                            brand that feels like freedom in your bones and expansion in your chest..."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="text-justify">
                            "You’re in the right place."<br /> "This is your space."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                ...
                <img
                    class="absolute  w-auto h-[60%] bottom-0 right-0 z-0"
                    src="/assets/images/kobieta_i_swieca_2_3_luiza.webp"
                    loading="lazy"
                    alt="Woman and candle"
                />
            </div>
        }
        }
        ...
        view! {
            <div class="bg-(--bg-sec)">
                <div class="space-y-6 py-10 px-[10%] bg-[url(/assets/images/liscie_o2.webp)] bg-center bg-size-[200%] bg-no-repeat">
                    <AnimateIn>
                        <p class="font-gistesy text-[7vw] md:text-4xl">
                            "There’s a fire in you..."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <p class="font-gistesy text-[7vw] md:text-4xl text-center">
                            "Let’s turn it into pure wild magnetism."
                        </p>
                    </AnimateIn>
                    <AnimateIn>
                        <div class="flex justify-center">
                ...
                {move || match save_data.get() {
                    Some(_data) => {
                        view! {
                            <div class="relative w-full flex justify-center">
                                <img
                                    class="absolute bottom-[-20] sm:bottom-[-15] left-0"
                                    src="assets/images/heart_line.webp"
                                    alt="line with heart"
                                />
                                <p required class="w-[40%] rounded-lg text-center p-1">
                                    "Success!"
                                </p>
                            </div>
                        }
                    ...
                    None => {
                        view! {
                            <form
                                on:submit=on_submit
                                class="relative w-full flex gap-1 justify-end"
                            >
                                <img
                                    class="absolute bottom-[-20] sm:bottom-[-15] left-0"
                                    src="assets/images/heart_line.webp"
                                ...
                                {move || {
                                    if is_pending.get() {
                                        view! { <p>"Sending..."</p> }.into_any()
                                    } else {
                                        view! {
                                            <input
                                                required
                                                class="w-[40%] rounded-lg text-center p-1"
