...
pub fn HomePage() -> impl IntoView {
    view! {
            <div class="max-w-225 mx-auto">
                <div class="relative m-7">
                    ...
                    <div class="-z-10 mask-t-from-0% mask-b-to-100% bg-[url(/assets/images/luiza_bnner.avif)] bg-contain bg-no-repeat">
                        <img
                            src="/assets/images/luiza_bnner.avif"
                            alt="Luiza"
                            class="-z-10 max-w-[80%]"
                        />
                    </div>
            ...
            //     <div class="m-7">
            //         <img
            //             src="/assets/images/luiza_bnner2.png"
            //             alt="Luiza"
            //             class="max-w-[80%] shadow-[20vw_20vw_0_#eae2dc]"
            //         />
            //         <div class="-translate-x-4 -translate-y-2 z-100 font-gistesy -rotate-8 atext md:text-8xl text-nowrap">
            //             <h1 class="opacity-50 z-100 text-center">
            //                 "Wild hearts don’t follow rules."
    ...
    "your wild magic &"
                    ...
                    <div class="grid grid-cols-2 content-center mx-2">
                        ...
                        <p class="text-xs text-center bg-[#FFFFFF] rounded-3xl m-1">"1h MASTERCLASS"</p>
                            <img class="h-32" src="../../assets/images/monitorek.avif" alt=""/>
                        </div>
                        <div class="place-self-center">
            ...
            <div class="space-y-10 bg-[url(/assets/images/liscie_o2.avif)] bg-center py-10">
                ...
                <div class="mx-[10%] bg-[#eae2dc] text-[4vw]/[6vw] md:text-2xl text-center space-y-6 py-6">
                    <p class="">
            ...
            <div  class="relative bg-[#574B44] px-[10%] pb-10">
                <div class="relative text-sm text-[#FCF9FA] pt-10 space-y-6 z-50">
            ...
            <div class="space-y-6 py-10 px-[10%] bg-[url(../../assets/images/liscie_o2.png)] bg-center bg-size-[200%] bg-no-repeat">
                <p class="font-gistesy text-[7vw]">"There’s a fire in you..."</p>
                <p class="font-gistesy text-[7vw] text-center">"Let’s turn it into pure wild magnetism."</p>
                <div class="flex justify-center">
                    <button class="text-nowrap text-xl bg-[#D4B3AB] h-auto rounded-full p-4 shadow-2xl ">"I'm So Ready to Rise!"</button>
                </div>
            </div>
            </div>
        }
